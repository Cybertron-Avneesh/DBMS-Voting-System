			...
			<div class="sidebar-content">
				...
				<div class="sidebar-menu">
					<ul>
						...
						<li class="sidebar-dropdown">
							<a href="./adminliveresult.php" id="activated">
								<i class="fa fa-chart-line"></i>
	...
	<div class="intro-area">
		<div class="main main-raised">
			<div>
				...
				<?php
					if ($_SERVER['REQUEST_METHOD'] == 'POST') {
						if($_POST['action'] == "Turn ON"){
							$sql= "update `admincontrol` set display_result=b'1' where display_result=b'0' or display_result=b'1'";
							// echo $sql;
							$result=mysqli_query($conn, $sql);
							if($result){
								// echo "Turned on";
							} else {
								// echo "Error communicating to server.";
							}
						} else {
							$sql= "update `admincontrol` set display_result=b'0' where display_result=b'0' or display_result=b'1'";
							// echo $sql;
							$result=mysqli_query($conn, $sql);
							if($result){
								// echo "Turned off";
				...
				?>
				<form class="" action="./adminliveresult.php" method="post">
					<div class="col-md-12">
						<input type="submit" class="btn btn-success" value="Turn ON" name="action"/>
						<input type="submit" class="btn btn-danger" value="Turn OFF" name="action"/>
						<span></span>
					</div>
				</form>
			</div>
